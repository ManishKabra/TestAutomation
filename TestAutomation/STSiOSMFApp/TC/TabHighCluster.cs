...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("cabe9477-ebe0-4009-b2a4-dfbb47dab085", ModuleType.Recording, 1)]
...
#region Variables
        ...
        /// </summary>
        [TestVariable("2285c78a-1e2f-4db3-a493-77bec951a0a0")]
        public string H2
        {
            get { return _H2; }
            set { _H2 = value; }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Section", "Validation## Navigate to Connect Screen, Tap on Connect HI and  HI connected successfully", new RecordItemIndex(34));
            
            // Step## Tap on Yes
            Report.Log(ReportLevel.Info, "Section", "Step## Tap on Yes", new RecordItemIndex(35));
            ...
            Report.Log(ReportLevel.Info, "Section", "Step## Press Check Sound Comfort", new RecordItemIndex(38));
            
            TapOn("Check Sound Comfort");
            Delay.Milliseconds(0);
            
            // Validation## Sound coumfort page appeared
            Report.Log(ReportLevel.Info, "Section", "Validation## Sound coumfort page appeared", new RecordItemIndex(40));
            
            VerifyActionBarTitle("Sound Comfort");
            Delay.Milliseconds(0);
            
            // Step## Selet the Cluster higher than the current i.e P5
            Report.Log(ReportLevel.Info, "Section", "Step## Selet the Cluster higher than the current i.e P5", new RecordItemIndex(42));
