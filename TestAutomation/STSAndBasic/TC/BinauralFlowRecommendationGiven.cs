...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("4e5fe826-922e-472c-a62d-89611f61fc0e", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            // Step## Enter Audiogram for both.Right - 40, 40, 50, 50 dB. Left - 20, 20, 90, 90 dB for frequencies 500Hz, 1kHz, 2kHz, 4kHz and Press Done
            Report.Log(ReportLevel.Info, "Section", "Step## Enter Audiogram for both.Right - 40, 40, 50, 50 dB. Left - 20, 20, 90, 90 dB for frequencies 500Hz, 1kHz, 2kHz, 4kHz and Press Done", new RecordItemIndex(8));
            ...
            ValidateMonauralHISelected("Run P_Targa P 5A", "Right");
            Delay.Milliseconds(0);
            ...
            ValidateBinauralHISelected("Run P_Targa P 5A", "Right");
            Delay.Milliseconds(0);
            
            ValidateBinauralCouplingSelected("Tip", "Right");
            Delay.Milliseconds(0);
            
            ValidateBinauralClusterSelected("P2", "Right");
            Delay.Milliseconds(0);
            
            ValidateBinauralHISelected("Run SP_Targa HP 5A", "Left");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Section", "Step## Adjust sound and volume sliders - Press test OK", new RecordItemIndex(49));
            ...
            Report.Log(ReportLevel.Info, "Section", "Step## Select Close session", new RecordItemIndex(53));
            
            CloseSession();
            Delay.Milliseconds(0);
            
            // Validation## Returns to Customer List
            Report.Log(ReportLevel.Info, "Section", "Validation## Returns to Customer List", new RecordItemIndex(55));
